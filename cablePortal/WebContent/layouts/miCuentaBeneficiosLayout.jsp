		...
		<c:set var="mainServiciosEnlinea" value="${ph[1]}"/>
			<div class="span-24">
                ...
                <div class="span-18 last">
					...
					<img style="margin-top:15px;" border="0" alt="NoPagos" src="/contentserver/groups/mercadotecnia/documents/imagen_cv/cv006249.jpg"/>
					<!-- 	<h2 class="servenlinea hidden-text">Portal de servicios en l&iacute;nea</h2>
						<div class="wrap-srvlineB bord-toped-111">
							<skeleton:child presentationContext="${mainServiciosEnlinea}"/>
						</div>
						<div class="beneficiosMiCuenta"></div>
					 -->
					</div>
				</div>
			</div>
